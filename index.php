...
<head>
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body BACKGROUND="img/red.jpg">
        <div class="container-fluid">

            <section id="welcome" class="tm-content-box tm-banner margin-b-10">
                <div class="tm-banner-inner">
                    <h1 class="tm-banner-title">Spandhan</h1>                        
                </div>                    
            </section>
                    ...
                    <nav class="tm-main-nav">
                        <ul class="tm-main-nav-ul">
                            ...
                            <li class="tm-nav-item"><a href="#gallery" class="tm-nav-item-link tm-button">
                                <i class="fa fa-image tm-nav-fa"></i>Images</a>
                            </li>
                ...
                <div class="tm-main-content">
                        ...
                        <div class="tm-welcome-boxes-container">
                            <div class="tm-welcome-box">
                                <div class="tm-welcome-text">
                                    <h2 class="tm-section-title">Spandhan Vidyalaya</h2>
                                    <p>We are a family, where God's love guides us all as we grow and expand year after year.Not just an orphanage,we are nearly a self sustaining organization;a working farm,a vibrant school.</p>    
                                </div>                            
                                <a href="#" class="tm-welcome-link tm-button">Learn More</a>
                            </div>
                            <div class="tm-welcome-box">
                                <div class="tm-welcome-text">
                                    <h2 class="tm-section-title">Spandhan Nivara</h2>
                                    <p> At the Spandhan Nivara we are much more than a home,for unwanted children.</p>    
                                </div>                            
                    ...
                    <div id="gallery" class="tm-content-box">                        
                        <div class="grid tm-gallery">
                            <figure class="effect-bubba">
                                <img src="img/2.jpg" alt="Image 8" class="img-fluid">
                                <figcaption>
                                    <h2>Play  <span>House</span></h2>
                                    <p>Place for fun!!!</p>
                            ...
                            <figure class="effect-bubba">
                                <img src="img/3.jpg" alt="Image 7" class="img-fluid">
                                <figcaption>
                                    <h2>Our  <span>Children</span></h2>
                            ...
                            <figure class="effect-bubba">
                                <img src="img/4.jpg" alt="Image 5" class="img-fluid">
                                <figcaption>
                                    <h2>Staff <span>Members</span></h2>
                                    <p></p>
                            ...
                            <figure class="effect-bubba">
                                <img src="img/5.jpg" alt="Image 3" class="img-fluid">
                                <figcaption>
                                    <h2>Festivals</h2>
                                    <p></p>
                            ...
                            <figure class="effect-bubba">
                                <img src="img/6.jpg" alt="Image 2" class="img-fluid">
                                <figcaption>
                                    <h2>Picnic</h2>
                                    <p></p>
                            ...
                            <figure class="effect-bubba">
                                <img src="img/7.jpg" alt="Image 4" class="img-fluid">
                                <figcaption>
                                    <h2>Classroom</h2>
                                    <p></p>
                    ...
                    <div id="services" class="tm-content-box tm-gray-bg tm-services">
                        ...
                        <div class="tm-services-img-container">
                            <img src="img/1.jpg" alt="Green Field" class="img-fluid tm-services-img">    
                        </div> 
                        ...
                        <div class="tm-box-pad tm-services-description-container">
                            ...
                            <p class="tm-section-description">Login form for <a href="../ccis/children/children-sign-up.php">children</a></p>
                        <p class="tm-section-description">Login form for <a href="../ccis/staff/staff-signup.php" class="tm-blue-text">Staff</a></p> 
						<p class="tm-section-description">Login form for <a href="../ccis/parent/PARENt.php">parent</a></p>
                        ...
                        <div class="tm-flex">
                            <div class="tm-contact-left-half tm-gray-bg">
                                <div class="tm-contact-inner-pad">
                                    ...
                                    <form action="cantactaction.php" method="post" class="contact-form">
                                        ...
                                        <div class="form-group">
                                            <input id="contact_message" name="contact_message" class="form-control" rows="9" placeholder="Message" required/>
                                        </div>
                                        
                                        <input type="submit" id="submit" name="submit" class=btn btn-primary pull-xs-right tm-button tm-button-normal" value="submit"/>
